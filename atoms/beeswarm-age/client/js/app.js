...
let legend = d3.select('.interactive-wrapper-bees-age')
.append("div")
...
agesVariables.map(v => {
	...
	let header = d3.select('.interactive-wrapper-bees-age')
	.append("div")
	...
	let subheader = d3.select('.interactive-wrapper-bees-age')
	.append("div")
	...
	let svg = d3.select('.interactive-wrapper-bees-age')
	.append("svg")
