...
let keyWrapper = d3.select('.interactive-wrapper-bees-senate-education')
.append("div")
...
const atomEl = d3.select('.interactive-wrapper-bees-senate-education').node();
...
let legend = d3.select('.interactive-wrapper-bees-senate-education')
.append("div")
...
educationVariables.map(v => {
	...
	let header = d3.select('.interactive-wrapper-bees-senate-education')
	.append("div")
	...
	let subheader = d3.select('.interactive-wrapper-bees-senate-education')
	.append("div")
	...
	let svg = d3.select('.interactive-wrapper-bees-senate-education')
	.append("svg")
