...
let keyWrapper = d3.select('.interactive-wrapper-bees-senate-urban-rural')
.append("div")
...
const atomEl = d3.select('.interactive-wrapper-bees-senate-urban-rural').node();
...
let legend = d3.select('.interactive-wrapper-bees-senate-urban-rural')
.append("div")
...
urbanRuralVariables.map(v => {
	...
	let header = d3.select('.interactive-wrapper-bees-senate-urban-rural')
	.append("div")
	...
	let subheader = d3.select('.interactive-wrapper-bees-senate-urban-rural')
	.append("div")
	...
	let svg = d3.select('.interactive-wrapper-bees-senate-urban-rural')
	.append("svg")
...
let paddingKeywrapper = isMobile ? 90 : 85;
